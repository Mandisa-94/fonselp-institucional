      ...
      <Box className={'boxCards'}>
        <Box className={'boxGratis'}>
          <Box className={'boxGratis_items'} mt={'5%'}>
            <h3 className={'h3 boxGratis_items_title'}>Proyectos con impacto</h3>
            <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
              <CheckOutlinedIcon className='check-blue'/>
              <p className={'text'}>Ofrecer donaciones en especie, capacitaciones, pro bono, voluntariado y otros.</p>
            </Box>
            <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
              <CheckOutlinedIcon className='check-blue'/>
              <p className={'text'}>Descubrir nuevas organizaciones alineadas con los objetivos de sostenibilidad de tu empresa.</p>
            </Box>
          </Box>
          <Box className={'boxGratis_items'}>
            ...
            <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
              <CheckOutlinedIcon className='check-blue'/>
              <p className={'text'}>Acceder a una base de organizaciones que ofrecen productos y servicios con impacto social y ambiental.</p>
            </Box>
            <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
              <CheckOutlinedIcon className='check-blue'/>
              <p className={'text'}>Realizar compras inclusivas con impacto social y ambiental.</p>
            </Box>
          </Box>
          <Box className={'boxGratis_items'}>
            ...
            <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
              <CheckOutlinedIcon className='check-blue'/>
              <p className={'text'}>Encontrar organizaciones cercanas que puedan necesitar tu scrap o lo que ya no uses.</p>
            </Box>
            <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
              <CheckOutlinedIcon className='check-blue'/>
              <p className={'text'}>Reducir tu impacto ambiental y acercar ayuda a quien la necesita.</p>
            </Box>
          </Box>
          <Box>
          ...
          <Box className={'boxPago_item'}>
            ...
            <Box className={'boxPago_item_title_description'}>
              <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
                ...
                <p className={'text-w'}>Proponer oportunidades de voluntariado a tus colaboradores.</p>
              </Box>
              <Box display={'flex'} textAlign={'left'} className={'boxIcon'}>
                <CheckOutlinedIcon className='check-white'/>
