  ...
  return (
    ...
    >
        <Box className={'titleBox'}>
                ...
                <p className=' titleBox_intro_title_text text'  style={{margin:'2rem'}}>Conoce a las organizaciones y causas que están guiando una nueva generación de innovadores.</p>
